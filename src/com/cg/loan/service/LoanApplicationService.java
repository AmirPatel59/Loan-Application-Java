...
public class LoanApplicationService {
	...
	public LoanApplication applyLoan() {
		...
		dbconnect.applyLoan(loan.getAmount(), loan.getLoanTypeId(), loan.getEmi(),loan.getLoanRepayPeriod(), loan.getMonthlyIncome(), loan.getRateOfInterest(), loan.getLoanStatus(),loan.getCustomerId());
		return loan;
	}
